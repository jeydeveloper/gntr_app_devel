...
class Crud_daftaraktivatetap extends CI_Model {
	//--------base---------------
	...
	function get_row(){
		return $this->db->get('aktivatetap')->row_array();
	}

	function get_all(){
		return $this->db->get('aktivatetap')->result_array();
	}

	function posts($data){
		return $this->db->insert('aktivatetap', $data);
	}

	function puts($data){
		return $this->db->update('aktivatetap', $data);
	}

	function delete($data){
		return $this->db->delete('aktivatetap', $data);
	}
}  