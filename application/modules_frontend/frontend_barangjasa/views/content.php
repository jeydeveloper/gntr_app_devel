                ...
                <tbody>
                  <?php if(!empty($result)): ?>
                    ...
                    <tr>
                      ...
                      <td><?php echo (!empty($static_data_source['barjas_jenis'][$value['brjs_jenis_id']]) ? $static_data_source['barjas_jenis'][$value['brjs_jenis_id']]['name'] : '-'); ?></td>
                      <td><?php echo $value['brjs_volume']; ?></td>
                      <td><?php echo (!empty($static_data_source['barjas_satuan'][$value['brjs_satuan_id']]) ? $static_data_source['barjas_satuan'][$value['brjs_satuan_id']]['name'] : '-'); ?></td>
                      <td><?php echo $value['brjs_harga_satuan']; ?></td>
                      <td><?php echo $value['brjs_over_project']; ?></td>
