              ...
              <form action="<?php echo ($module_base_url . '/edit/' . $detail['bpu_id']); ?>" method="post">
                ...
                <div class="form-fields">
                  ...
                  <div class="field">
                    ...
                    <input id="bpu_harga" name="bpu_harga" placeholder="Harga" value="<?php echo $detail['bpu_harga']; ?>" required />
                  </div> <!-- /field -->

                  <div class="field">
                    <label for="bpu_terbilang">Terbilang</label>
                    <input id="bpu_terbilang" name="bpu_terbilang" placeholder="Terbilang" value="<?php echo $detail['bpu_terbilang']; ?>" required />
                  </div> <!-- /field -->
