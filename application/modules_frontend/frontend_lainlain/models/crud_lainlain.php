...
class Crud_lainlain extends CI_Model {
	//--------base---------------
	...
	function get_row(){
		return $this->db->get('saham')->row_array();
	}

	function get_all(){
		return $this->db->get('saham')->result_array();
	}
	...
	function puts($data){
		return $this->db->update('saham', $data);
	}

	function delete($data){
		return $this->db->delete('saham', $data);
	}
}  