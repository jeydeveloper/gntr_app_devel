...
<html lang="en">
    ...
    <head>
        ...
        <link rel="apple-touch-icon-precomposed" sizes="144x144" href="<?php echo $assets; ?>/ico/apple-touch-icon-144-precomposed.png">
        <link rel="apple-touch-icon-precomposed" sizes="114x114" href="<?php echo $assets; ?>/ico/apple-touch-icon-114-precomposed.png">
        <link rel="apple-touch-icon-precomposed" sizes="72x72" href="<?php echo $assets; ?>/ico/apple-touch-icon-72-precomposed.png">
        <link rel="apple-touch-icon-precomposed" href="<?php echo $assets; ?>/ico/apple-touch-icon-57-precomposed.png">
